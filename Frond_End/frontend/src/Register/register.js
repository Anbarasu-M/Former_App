        ...
        <form className="container col-md-4 col-sm-6 Former_Register text-center">
            ...
            {errors.place && <p className="text-danger">{errors.place}</p>} */}
                ...
                <div className="text-center">
                    <button type="submit" onClick={handleClick} className="btn btn-primary btn-xs">Register</button>
                </div>
                <sapn>If you already have account <Link to="/login"> Login Here</Link></sapn>
                <Outlet />
            </div>
        </form>
    </div>
